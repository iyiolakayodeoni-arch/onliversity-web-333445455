      ...
      <div className="mx-auto max-w-6xl px-3 py-6 sm:px-6 sm:py-8">
        ...
        <div className="rounded-lg border border-primary/20 bg-primary/5 p-6 text-center">
          ...
          <div className="mt-4 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <div className="flex items-center gap-2 rounded border border-border bg-surface px-4 py-2.5 opacity-70">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="text-foreground">
                <path d="M12 3v12m0 0l-4-4m4 4l4-4M5 19h14" />
              </svg>
              <div>
                <p className="font-mono text-[9px] uppercase tracking-widest text-muted">Coming soon</p>
