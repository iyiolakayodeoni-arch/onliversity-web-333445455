...
export function EmailCapture({ variant = "hero", placeholder = "your@email.com" }: { variant?: "hero" | "inline" | "footer"; placeholder?: string }) {
    ...
    return (
      <div className="rounded-2xl border border-primary/20 bg-primary/10 px-4 py-3 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-muted">We&apos;ll email you when Season One news drops. No spam — just honest updates.</p>
        </div>
      </div>
    );
  }
